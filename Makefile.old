...
#     PREREQ_PM => { XML::XPathEngine=>q[0.08], HTML::TreeBuilder=>q[0] }
#     VERSION_FROM => q[lib/HTML/TreeBuilder/XPath.pm]
...
MAKE = make
FULLEXT = HTML/TreeBuilder/XPath
BASEEXT = XPath
PARENT_NAME = HTML::TreeBuilder
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/TreeBuilder/XPath.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/HTML/TreeBuilder
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/HTML/TreeBuilder
...
TO_INST_PM = lib/HTML/TreeBuilder/XPath.pm

PM_TO_BLIB = lib/HTML/TreeBuilder/XPath.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    XML::XPathEngine:              0.08' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="XML-XPathEngine" VERSION="0,08,0,0" />' >> $(DISTNAME).ppd
